...
var defaults={globalStyles:!0,mediaPrint:!1,stylesheet:"css/print.css",noPrintSelector:".no-print",iframe:!0,append:"www.alomariya.org",prepend:"www.alomariya.org",manuallyCopyFormValues:!0,deferred:$.Deferred(),timeout:750,title:null,doctype:'<!doctype html>'};options=$.extend({},defaults,(options||{}));var $styles=$("");if(options.globalStyles){$styles=$("style, link, meta, base, title")}else if(options.mediaPrint){$styles=$("link[media=print]")}
